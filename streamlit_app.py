...
<head>
  ...
  <style>
    ...
    .patient-header {{ background-color: white; padding: 10px 30px; border-bottom: 2px solid orangered; }}
    .patient-header h3 {{ margin: 0; color: #333; font-size: 18px; }}
    .container {{ text-align: center; margin-top: 20px; }}
    .controls {{
      margin: 20px auto; max-width: 900px; display: flex; gap: 10px;
    ...
    button.active {{ background-color: #8b1a00; }}
    .table-wrapper {{
...
<body>
  ...
  <div class="patient-header">
    <h3>Sample: {safe_patient_html}</h3>
  </div>
  <div class="container">
    <div class="controls">
