...
.gca-upload-card .gca-card-title{margin-bottom:.75rem}
...
with col1:
    st.markdown('<div class="gca-upload-card">', unsafe_allow_html=True)
    st.markdown(
    ...
    if "Raw Excel" in input_type:
        ...
        with st.expander("➕ Add Mitochondrial Data (optional)"):
            ...
            if mito_file:
                ...
                st.session_state.mito_data = None
    st.markdown('</div>', unsafe_allow_html=True)  # close gca-upload-card
